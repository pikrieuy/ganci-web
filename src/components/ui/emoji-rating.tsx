  ...
  return (
    <div className={cn("flex flex-col items-center gap-6", className)}>
      ...
      <div className="relative h-7 w-32">
        ...
        >
          <span className="text-sm font-sans font-medium text-gray-text">Rate us</span>
        </div>
        ...
        {ratingData.map((item, i) => (
          ...
          >
            <span className="text-sm font-sans font-semibold tracking-wide text-purple-dark">{item.label}</span>
          </div>
        ))}
      </div>
    </div>
